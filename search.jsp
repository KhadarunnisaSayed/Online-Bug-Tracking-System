                                        ...
                                        <div class="clearfix">
                                            <div class="nav-collapse nav-collapse_">
                                                <ul class="nav sf-menu clearfix">
                                                    ...
                                                    <li class="active"><a href="dred.jsp">Bug Check</a></li>
                ...
                <div class="row">
                    <article class="span4" style="color: white">
                        ...
                        <ol class="list1">
                            ...
                            <li><a href="affix.jsp">Affix New Bug</a></li>
                            <li><a href="buganalyse.jsp">Analyse Bug Report</a></li>
                            <li><a href="dred.jsp">Bug Check</a></li>
                            <li><a href="index.jsp">Logout</a></li>
                        </ol>
                    </article>
                    <article class="span8 about-box">
                        <h5 style="color: white;margin-top: 10px;margin-left: -50px">Bug Tracker</h5>
                        <table style="margin-left: -210px;width: 1000px">
                            ...
                            <%
                                    ...
                                    System.out.println("2222222222222222@"+term);
                                    String sql = "select * from bug where summary like '%"+term+"%' ";
                        ...
                        <div class="row">
                            <nav class="span6">
                                <ul>
                                    ...
                                    <li><a href="affix.jsp">Affix New Bug</a></li>
                                    <li><a href="buganalyse.jsp">Analyse Bug Report</a></li>
                                    <li class="active"><a href="dred.jsp">Data Reduction</a></li>
                                    <li><a href="index.jsp">Logout</a></li>
                                </ul>
                            </nav>
